          ...
          <div className="shrink-0 flex items-center gap-2">
            <Link
              ...
              className="relative rounded-full bg-white/10 p-2 hover:bg-white/15
                         backdrop-blur-md ring-1 ring-white/20 transition group"
          ...
          <div className="flex items-center bg-white/15 hover:bg-white/20
            ...
            <button
              ...
              className="ml-2 bg-white text-emerald-700 px-3 py-2 rounded-lg
                         text-sm font-medium hover:shadow-md transition active:scale-[.98]"
            >
              Buscar
            </button>
            <button
              ...
              className="ml-2 bg-white/15 hover:bg-white/25 text-white p-2 rounded-lg
                         ring-1 ring-white/40 transition active:scale-[.98]"
              title="Filtros"
            ...
            {categorias.map(({ nome, img }) => (
              <li key={nome}>
                <button
                  ...
                  className="
                    group inline-flex items-center gap-2 h-11 px-3 pr-4 rounded-full
                    outline outline-1 outline-white/25 -outline-offset-1
                    bg-white/10 hover:bg-white/15 transition
                    hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(0,0,0,0.15)]
                  "
                  ...
                  <span className="relative shrink-0 w-9 h-9 rounded-full overflow-hidden bg-white/0">
                    <img
                      ...
                      className="absolute inset-0 w-full h-full object-cover
                                 scale-[1.35] md:scale-[1.25] transition-transform
                                 group-hover:scale-[1.45] group-hover:translate-x-[1px] group-hover:-translate-y-[1px]"
                      draggable={false}
                    />
                  </span>
