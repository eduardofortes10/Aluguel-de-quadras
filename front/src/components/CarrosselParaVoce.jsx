...
export default function Home() {
  ...
  const [sliderRef, instanceRef] = useKeenSlider({
    ...
    drag: true,
    rubberband: true,
    // desktop mostrando um "cheirinho" do próximo card
    slides: { perView: 4.15, spacing: 16 },
    breakpoints: {
  ...
  return (
    <div className="flex min-h-screen overflow-x-hidden bg-white">
      ...
      <main className="flex-1 text-black transition-colors px-3 sm:px-4 md:pl-16 overflow-visible">
        ...
        <div className="max-w-7xl xl:max-w-[88rem] mx-auto w-full px-6 pt-16 md:pt-10">
        ...
        <footer className="bg-[#0f3d26] text-white mt-12">
          <div className="max-w-7xl xl:max-w-[88rem] mx-auto px-6 py-8 sm:py-10">
