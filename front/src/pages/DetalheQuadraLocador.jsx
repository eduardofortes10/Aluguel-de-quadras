...
import { api } from "../services/api";           // ← usamos o cliente /api
import { fileURL } from "../services/api";       // ← helper p/ montar URL de imagens
...
export default function DetalheQuadraLocador() {
  ...
  // Atualiza perView ao redimensionar
  useEffect(() => {
    const handleResize = () => setPerView(window.innerWidth < 640 ? 1 : 3);
    window.addEventListener("resize", handleResize);
    return () => window.removeEventListener("resize", handleResize);
  }, []);

  // Quando perView mudar, atualiza o slider (evita recriar)
  useEffect(() => {
  ...
  // Carregar detalhes da quadra (sem localhost)
  useEffect(() => {
              ...
              return (
                ...
                >
                  <img
                    ...
                    src={fileURL(url)}               // ← nada de localhost
          ...
          {imagemSelecionada && (
            <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
              <div className="relative max-w-4xl w-full p-4">
                ...
                <img
                  src={fileURL(imagemSelecionada)}  // ← idem aqui
                  alt="Imagem ampliada"
