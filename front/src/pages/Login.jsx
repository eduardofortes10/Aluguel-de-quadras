...
export default function Login() {
  ...
  // Partículas (mantido, mas sem hero com imagem)
  ...
  return (
    <main className="relative min-h-screen bg-neutral-950">
      ...
      {/* ÚNICA SEÇÃO (sem imagem lateral) */}
        ...
        <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-white/80 backdrop-blur-xl shadow-[0_10px_40px_rgba(0,0,0,0.15)]">
          <div className="px-6 sm:px-8 py-7">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              >
                {carregando && <span className="loader-small" aria-hidden="true" />}
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                type="button"
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white border hover:shadow-md transition"
              >
